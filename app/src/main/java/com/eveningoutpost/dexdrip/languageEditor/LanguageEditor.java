...
public class LanguageEditor extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (languageItemList.size() == 0 || Locale.getDefault().toString().startsWith("en")) {
            if (Locale.getDefault().toString().startsWith("en")) {
                ...
                alertDialogBuilder.setNegativeButton(getString(R.string.ok), (OnClickListener) (dialog, which) -> finish());
                ...
                alertDialogBuilder.setNegativeButton("No, don't request my language", (dialog, which) -> finish());
                alertDialogBuilder.setPositiveButton("Yes, please support my language", (dialog, which) -> {
                    // fire off a request!
    ...
    public void languageResetEverything(MenuItem v) {
        ...
        alertDialogBuilder.setNegativeButton("No, keep my data", (dialog, which) -> {
        });
        alertDialogBuilder.setPositiveButton("Delete all language edits", (dialog, which) -> {
    ...
    private void getConsent() {
        ...
        builder.setPositiveButton("I ASSIGN COPYRIGHT TO THE PROJECT", (dialog, which) -> {
