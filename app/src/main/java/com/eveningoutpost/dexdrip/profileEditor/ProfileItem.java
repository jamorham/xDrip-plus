...
public class ProfileItem {
    ...
    {
        return String.format(Locale.getDefault(), "%02d:%02d",start_min / 60,start_min %60)+" -> "+String.format("%02d:%02d",end_min/60, end_min %60);
    }

    public String getTimeStart()
    {
        return String.format(Locale.getDefault(), "%02d:%02d",start_min / 60,start_min %60);
    }
    public String getTimeEnd()
    {
        return String.format(Locale.getDefault(), "%02d:%02d",end_min / 60,end_min %60);
    }
    ...
    {
//        try {
//            ProfileItem profileItem = (ProfileItem) super.clone();
