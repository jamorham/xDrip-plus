...
import com.eveningoutpost.dexdrip.ui.charts.*;
import com.eveningoutpost.dexdrip.ui.helpers.*;

import java.util.*;

import lecho.lib.hellocharts.animation.*;
...
public class BasalProfileEditor extends AppCompatActivity implements AdapterView.OnItemSelectedListener, ChartAnimationListener {
    ...
    private void buttonsToMatchStep() {
        plusButton.setText("+" + basalStepSpinner.getSelectedItem());
        minusButton.setText("-" + basalStepSpinner.getSelectedItem());
    }
