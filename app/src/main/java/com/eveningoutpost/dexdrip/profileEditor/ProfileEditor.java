                ...
                new RecyclerView.AdapterDataObserver() {
                    ...
                    public void onItemRangeChanged(final int positionStart, int itemCount, Object payload) {
                        ...
                        if (payload.toString().equals("time start updated")) {
                            ...
                            alertDialogBuilder.setPositiveButton(small_screen ? getString(R.string.split) : getString(R.string.split_this_block_in_two), (OnClickListener) (arg0, arg1) -> {
                            ...
                            if (profileItemList.size() > 1) {
                                alertDialogBuilder.setNeutralButton(small_screen ? getString(R.string.delete) : getString(R.string.delete_this_time_block), (OnClickListener) (dialog, which) -> {
                                    profileItemList.remove(positionStart);
                                    forceRefresh();
                                });
                            }

                            alertDialogBuilder.setNegativeButton(small_screen ? getString(R.string.cancel) : getString(R.string.cancel_do_nothing), (OnClickListener) (dialog, which) -> {
