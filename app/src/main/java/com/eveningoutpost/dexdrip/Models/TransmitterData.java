...
public class TransmitterData extends Model {
    ...
    public static synchronized TransmitterData create(byte[] buffer, int len, Long timestamp) {
        ...
        if ((buffer[0] == 0x11 || buffer[0] == 0x15) && buffer[1] == 0x00) { //Code from savek-cc experimental
            ...
            //Code from savek-cc experimental
            if (buffer[0] == 0x15) {
            ...
            transmitterData.timestamp = timestamp; //Code from savek-cc experimental
        }
        ...
        // Removed code from savek-cc experimental // transmitterData.timestamp = timestamp;
