 ...
 */
public class InstallPebbleWatchFace extends BaseActivity {
    ...
    private boolean checkPermissions() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (ContextCompat.checkSelfPermission(getApplicationContext(),
                ...
                JoH.show_ok_dialog(activity, gs(R.string.please_allow_permission), "Need storage permission to install watchface", () -> ActivityCompat.requestPermissions(activity,
    ...
    public void askToInstall() {
        ...
        builder.setNegativeButton("NO", (OnClickListener) (dialog, which) -> {
            dialog.dismiss();
            finish();
        });
