...
public class NotificationChannels {
    ...
    public static NotificationChannel getChan(Builder wip) {
        ...
        template.setVibrationPattern(wip.getNotification()/*.mNotification*/.vibrate);
        template.setSound(wip.getNotification()/*.mNotification*/.sound, generic_audio);
        template.setLightColor(wip.getNotification()/*.mNotification*/.ledARGB);
        if ((wip.getNotification()/*.mNotification*/.ledOnMS != 0) && (wip.getNotification()/*.mNotification*/.ledOffMS != 0))
