...
public class NightscoutTreatments {
    ...
    public static boolean processTreatmentResponse(final String response) throws Exception {
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            final String uuid = (tr.has("uuid") && (tr.getString("uuid") != null)) ? tr.getString("uuid") : UUID.nameUUIDFromBytes(tr.getString("_id").getBytes(StandardCharsets.UTF_8)).toString();
