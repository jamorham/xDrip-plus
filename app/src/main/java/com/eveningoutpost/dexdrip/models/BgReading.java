...
public class BgReading extends Model implements ShareUploadableBg {
    ...
    static BgReading getForPreciseTimestamp(long timestamp, double precision, boolean lock_to_sensor) {
        ...
        Log.d(TAG, "getForPreciseTimestamp: No luck finding a BG timestamp match: " + JoH.dateTimeText(timestamp) + " precision:" + precision + " Sensor: " + ((sensor == null) ? "null" : sensor.getId()));
        return null;
    }
