...
import com.eveningoutpost.dexdrip.glucoseMeter.caresens.*;
...
import static com.eveningoutpost.dexdrip.glucoseMeter.VerioHelper.*;
import static com.eveningoutpost.dexdrip.models.CalibrationRequest.*;
...
public class BluetoothGlucoseMeter extends Service {
    ...
    private static void setHighestSequence(int sequence) {
        ...
        Inevitable.task("set-bt-glucose-highest", 1000, () -> {
