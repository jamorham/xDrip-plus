...
public class DoubleCalibrationActivity extends ActivityWithMenu {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.eveningoutpost.dexdrip.databinding.ActivityDoubleCalibrationBinding binding = com.eveningoutpost.dexdrip.databinding.ActivityDoubleCalibrationBinding.inflate(getLayoutInflater());
