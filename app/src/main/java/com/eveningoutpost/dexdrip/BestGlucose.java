...
public class BestGlucose {
    ...
    public static class DisplayGlucose {
        ...
        public String minutesAgo(boolean include_words) {
            ...
            return minutes + (include_words ? (((minutes == 1) ? xdrip.getAppContext().getString(R.string.space_minute_ago) : xdrip.getAppContext().getString(R.string.space_minutes_ago))) : "");
        }
