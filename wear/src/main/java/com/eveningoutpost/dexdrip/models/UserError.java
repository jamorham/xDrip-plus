...
public class UserError extends PlusModel {
    ...
    private static final String[] schema = {"CREATE TABLE UserErrors (_id INTEGER PRIMARY KEY AUTOINCREMENT, message TEXT, severity INTEGER, shortError TEXT, timestamp REAL)", "CREATE INDEX index_UserErrors_timestamp on UserErrors(timestamp)", "CREATE INDEX index_UserErrors_severity on UserErrors(severity)"};
