...
public class LibreOOPAlgorithm {
    ...
    static public void SendData(byte[] fullData, long timestamp) {
       ...
       UserError.Log.i(TAG, "Data that will be sent is " + HexDump.dumpHexString(fullData));
    ...
    static public void HandleData(String oopData) {
       UserError.Log.e(TAG, "HandleData called with " + oopData);
        ...
        libreAlarmObject.data.trend = new ArrayList<>();
       ...
       // Add the historic data
        libreAlarmObject.data.history = new ArrayList<>();
       ...
       UserError.Log.e(TAG, "HandleData Created the following object " + libreAlarmObject.toString());
