...
public class AlertType extends Model {
    ...
    public static AlertType get_highest_active_alert(Context context, double bg) {
        ...
        if (at != null) {
           UserError.Log.d(TAG_ALERT, "get_highest_active_alert_helper returned alert uuid = " + at.uuid + " alert name = " + at.name);
        } else {
    ...
    public static void print_all() {
       ...
       UserError.Log.d(TAG,"List of all alerts");
        for (AlertType alert : Alerts) {
           UserError.Log.d(TAG, alert.toString());
        }
    }
    ...
    public static void testAll(Context context) {
       ...
       UserError.Log.d(TAG, "a1 = " + a1.toString());
        AlertType a2 = get_highest_active_alert(context, 210);
       UserError.Log.d(TAG, "a2 = " + a2.toString());


        AlertType a3 = get_alert(a1.uuid);
       UserError.Log.d(TAG, "a1 == a3 ? need to see true " + (a1==a3) + a1 + " " + a3);
       ...
       UserError.Log.d(TAG, "HigherAlert(a1, a2) = a1?" +  (HigherAlert(a1,a2) == a2));
       UserError.Log.d(TAG, "HigherAlert(al1, al2) = al1?" +  (HigherAlert(al1,al2) == al2));
       UserError.Log.d(TAG, "HigherAlert(a1, al1) = al1?" +  (HigherAlert(a1,al1) == al1));
       UserError.Log.d(TAG, "HigherAlert(al1, a2) = al1?" +  (HigherAlert(al1,a2) == al1));
    ...
    static public boolean  s_in_time_frame(boolean s_all_day, int s_start_time_minutes, int s_end_time_minutes) {
       ...
       UserError.Log.d(TAG, "time_now is " + time_now + " minutes" + " start_time " + s_start_time_minutes + " end_time " + s_end_time_minutes);
 ...
 // return the hours part of the time
    ...
    public static boolean toSettings(Context context) {
       ...
       UserError.Log.e(TAG, "Created the string " + output);
        prefs.edit().putString("saved_alerts", output).apply();
