...
public class BgGraphBuilder {
    ...
    private List<PointValue> rawInterpretedValues = new ArrayList<>();
    private List<PointValue> filteredValues = new ArrayList<>();
    private List<PointValue> calibrationValues = new ArrayList<>();
